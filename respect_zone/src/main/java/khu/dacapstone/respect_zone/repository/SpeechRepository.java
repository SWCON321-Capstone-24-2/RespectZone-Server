...
public interface SpeechRepository extends JpaRepository<Speech, Long> {
    ...
    @Query("SELECT new khu.dacapstone.respect_zone.domain.Speech(s.id, s.deviceId, s.createdAt, s.recordingTime, s.burningCount, s.sentenceCount, s.swearCount) FROM Speech s WHERE s.deviceId = :deviceId")
